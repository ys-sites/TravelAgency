...
export default function PortfolioClient() {
  ...
  // No timer/pause useEffect to allow infinite video looping
  ...
  return (
    <div className="min-h-screen w-full bg-[#FAF9F5] bg-[radial-gradient(circle_at_75%_20%,rgba(197,168,128,0.12),transparent_55%),radial-gradient(circle_at_25%_80%,rgba(197,168,128,0.08),transparent_55%)] flex items-center justify-center font-sans antialiased text-zinc-900 selection:bg-[#C5A880]/20 selection:text-zinc-900">
      <div className="w-full max-w-[430px] mx-auto min-h-screen md:min-h-[850px] md:my-10 md:rounded-[2.5rem] md:border md:border-zinc-200/80 md:shadow-[0_20px_50px_rgba(0,0,0,0.08)] bg-white overflow-hidden flex flex-col relative">
        ...
        <div className="absolute bottom-[80px] right-[-70px] w-[220px] h-[220px] bg-[#C5A880]/6 rounded-full blur-[65px] pointer-events-none z-0" />
 
        {/* Cover Strip */}
        <div className="relative w-full h-[180px] flex-shrink-0 bg-zinc-100 overflow-hidden z-10">
          <video
            ref={videoRef}
        ...
        <div className="flex-1 flex flex-col px-6 -mt-12 pb-8 relative z-10">
          ...
          <motion.div {...premiumFadeUp(0)} className="flex flex-col items-center text-center space-y-3">
            <div className="w-[96px] h-[96px] rounded-full overflow-hidden border-2 border-[#C5A880] bg-white p-1 flex items-center justify-center shadow-lg">
              <img 
                src="/images/logo.png" 
          ...
          <motion.div {...premiumFadeUp(0.08)} className="grid grid-cols-2 gap-3.5 mt-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border border-[#C5A880]/40 bg-[#C5A880]/5 hover:bg-[#C5A880]/15 text-zinc-800 font-semibold uppercase text-[11px] tracking-wider rounded-full py-3.5 text-center transition-all hover:scale-[1.03] active:scale-95 duration-300"
            >
          ...
          <motion.div {...premiumFadeUp(0.16)} className="flex justify-center gap-3.5 mt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-11 h-11 rounded-full border border-zinc-200 hover:border-[#C5A880] flex items-center justify-center text-zinc-700 hover:text-[#C5A880] hover:scale-110 transition-all duration-300 bg-zinc-50 hover:bg-[#C5A880]/5"
            >
              <InstagramIcon />
            </a>
